...
# Load datasets
raw_df = pd.read_csv("https://github.com/MansiShinde29/Streamlit/blob/main/Stremlit/Messy_Employment_India_Dataset.csv")
cleaned_df = pd.read_csv("https://github.com/MansiShinde29/Streamlit/blob/main/Stremlit/cleaned_Dataset.csv")
